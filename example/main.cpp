...
class ExampleHTTPHandler : public spaznet::HTTPHandler {
  public:
    spaznet::Task handle_request(const spaznet::HTTPRequest& request,
        ...
        std::cout << "HTTP Request: " << request.method << " " << request.request_target
                  << std::endl;
...
class ExampleUDPHandler : public spaznet::UDPHandler {
  public:
    spaznet::Task handle_packet(const spaznet::UDPPacket& packet,
                                spaznet::Socket& socket) override {
...
class ExampleWebSocketHandler : public spaznet::WebSocketHandler {
  public:
    ...
    spaznet::Task handle_message(const spaznet::WebSocketMessage& message,
                                 spaznet::Socket& socket) override {
