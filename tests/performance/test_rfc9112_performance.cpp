...
TEST_F(RFC9112PerformanceTest, SerializeResponseSmall) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Small response serialization: " << avg_time_us << " μs/response" << std::endl;
...
TEST_F(RFC9112PerformanceTest, SerializeResponseMedium) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Medium response serialization: " << avg_time_us << " μs/response" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " responses/sec" << std::endl;
...
TEST_F(RFC9112PerformanceTest, SerializeResponseLarge) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Large response serialization: " << avg_time_us << " μs/response" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " responses/sec" << std::endl;
...
TEST_F(RFC9112PerformanceTest, SerializeResponseChunked) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Chunked response serialization: " << avg_time_us << " μs/response" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " responses/sec" << std::endl;
...
TEST_F(RFC9112PerformanceTest, HeaderLookupPerformance) {
    ...
    std::cout << "\n[PERF] Header lookup (case-insensitive): " << avg_time_us << " μs/lookup" << std::endl;
