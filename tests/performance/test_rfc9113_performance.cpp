...
protected:
    ...
    void generate_test_data() {
        ...
        small_response.body = {'<', 'h', '1', '>', 'H', 'e', 'l', 'l', 'o', '<', '/', 'h', '1', '>'};
...
TEST_F(RFC9113PerformanceTest, BuildHeadersFrameSmall) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Small HEADERS frame building: " << avg_time_us << " μs/frame" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " frames/sec" << std::endl;
...
TEST_F(RFC9113PerformanceTest, BuildHeadersFrameMedium) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Medium HEADERS frame building: " << avg_time_us << " μs/frame" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " frames/sec" << std::endl;
...
TEST_F(RFC9113PerformanceTest, ResponseToFramesSmall) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Small response to_frames: " << avg_time_us << " μs/response" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " responses/sec" << std::endl;
...
TEST_F(RFC9113PerformanceTest, ResponseToFramesLarge) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / iterations;
    std::cout << "\n[PERF] Large response to_frames: " << avg_time_us << " μs/response" << std::endl;
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " responses/sec" << std::endl;
...
TEST_F(RFC9113PerformanceTest, MultipleFramesRoundTrip) {
    ...
    double avg_time_us = static_cast<double>(duration.count()) / (iterations * frames_per_iteration);
...
TEST_F(RFC9113PerformanceTest, StreamManagement) {
    ...
    std::cout << "[PERF] Throughput: " << (1000000.0 / avg_time_us) << " operations/sec" << std::endl;
